  ...
  export default{
      ...
      methods : {
        ...
        randomSolid(){
          ...
          this.domBody.style.backgroundColor = this.preview.style.backgroundColor = `#${rgb}`;
        },
        imgUrl(){
          this.preview = document.querySelector('.preview');
          ...
          this.domBody.style.backgroundPosition = this.preview.style.backgroundPosition = 'center'; // background-Position : 배경 이미지의 위치를 정하는 속성
